...
public interface Message extends ISnowflake, Formattable {
     ...
     * @return Immutable list of mentioned Members
     * @throws java.lang.UnsupportedOperationException If this is not a Received Message from {@link net.dv8tion.jda.core.entities.MessageType#DEFAULT MessageType.DEFAULT}
     * @throws java.lang.IllegalStateException         If this message was not sent in a {@link net.dv8tion.jda.core.entities.TextChannel TextChannel}
     * @since 3.4.0
     */
     ...
     * @throws java.lang.UnsupportedOperationException If this is not a Received Message from {@link net.dv8tion.jda.core.entities.MessageType#DEFAULT MessageType.DEFAULT}
     * @throws java.lang.IllegalStateException         If the message attempting to be edited was not created by the currently logged in account, or if
     ...
     * <br>The {@link net.dv8tion.jda.core.entities.Message Message} with the updated content
     * @throws java.lang.UnsupportedOperationException If this is not a Received Message from {@link net.dv8tion.jda.core.entities.MessageType#DEFAULT MessageType.DEFAULT}
     * @throws java.lang.IllegalStateException         If the message attempting to be edited was not created by the currently logged in account, or
     ...
     * </ul>
     *
     * @param format Format String used to generate the Message's content via
     ...
     * @throws IllegalStateException                   If the message attempting to be edited was not created by the currently logged in account
     */
    @CheckReturnValue
     ...
     * @throws java.lang.UnsupportedOperationException                         If this is a Data Message (output of {@link net.dv8tion.jda.core.MessageBuilder MessageBuilder})
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If this Message was not sent by the currently logged in account, the Message was sent in a
     ...
     *                                                                         the channel.
     * @throws java.lang.IllegalStateException                                 If this Message was not sent by the currently logged in account and it was <b>not</b> sent in a
     ...
     * </ul>
     *
     * @param emote The {@link net.dv8tion.jda.core.entities.Emote Emote} to add as a reaction to this Message.
     * @return {@link net.dv8tion.jda.core.requests.RestAction RestAction} - Type: {@link java.lang.Void}
     * @throws java.lang.UnsupportedOperationException                         If this is not a Received Message from {@link net.dv8tion.jda.core.entities.MessageType#DEFAULT MessageType.DEFAULT}
     ...
     *                                                                         {@link net.dv8tion.jda.core.Permission#MESSAGE_MANAGE Permission.MESSAGE_MANAGE} in the channel.
     * @throws java.lang.IllegalStateException                                 If this message was <b>not</b> sent in a
     *                                                                         {@link net.dv8tion.jda.core.entities.TextChannel TextChannel}.
     */
    @CheckReturnValue
    ...
    class Attachment implements ISnowflake {
         ...
         *
         * @param then Not-null {@link net.dv8tion.jda.core.utils.IOConsumer IOConsumer} to accept the InputStream
         * @throws java.lang.IllegalArgumentException If the provided IOConsumer is {@code null}
         * @throws IOException                        If an IOException occurs within the IOConsumer or while opening an HTTP channel
         * @since 3.4.0
         */
