...
public class MessageReaction {
     ...
     *
     * @param channel   The {@link net.dv8tion.jda.core.entities.MessageChannel} this Reaction was used in
     * @param emote     The {@link net.dv8tion.jda.core.entities.MessageReaction.ReactionEmote ReactionEmote} that was used
     ...
     * @throws java.lang.IllegalStateException If this MessageReaction is from an event which does not provide a count
     */
    public int getCount() {
        if (count < 0)
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException if the provided User is not us and we do not have permission to
