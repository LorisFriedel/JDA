...
public class MessageHistory {
     ...
     *
     * @param channel The {@link net.dv8tion.jda.core.entities.MessageChannel MessageChannel} to retrieval history from.
     */
     ...
     * @throws java.lang.IllegalArgumentException The the {@code amount} is less than {@code 1} or greater than {@code 100}.
     */
    @CheckReturnValue
     ...
     * starting at index 0. If the list is empty, there were no more messages left to retrieve.
     * @throws java.lang.IllegalArgumentException The the {@code amount} is less than {@code 1} or greater than {@code 100}.
     * @throws java.lang.IllegalStateException    If no messages have been retrieved by this MessageHistory.
     */
    @CheckReturnValue
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If this is a TextChannel and the currently logged in account does not
