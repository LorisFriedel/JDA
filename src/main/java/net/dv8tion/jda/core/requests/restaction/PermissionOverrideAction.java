...
public class PermissionOverrideAction extends AuditableRestAction<PermissionOverride> {
     ...
     * @param route   The {@link net.dv8tion.jda.core.requests.Route.CompiledRoute Route.CompiledRoute} to be used for rate limit handling
     * @param channel The target {@link net.dv8tion.jda.core.entities.Channel Channel} for the PermissionOverride
     * @param member  The target {@link net.dv8tion.jda.core.entities.Member Member} that will be affected by the PermissionOverride
     */
     ...
     * @param route   The {@link net.dv8tion.jda.core.requests.Route.CompiledRoute Route.CompiledRoute} to be used for rate limit handling
     * @param channel The target {@link net.dv8tion.jda.core.entities.Channel Channel} for the PermissionOverride
     * @param role    The target {@link net.dv8tion.jda.core.entities.Role Role} that will be affected by the PermissionOverride
     */
     ...
     *
     * @param allowBits The <b>positive</b> bits representing the granted
     *                  permissions for the new PermissionOverride
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the provided bits are negative
     ...
     *
     * @param permissions The Collection of Permissions representing the granted
     *                    permissions for the new PermissionOverride.
     *                    <br>If the provided value is {@code null} the permissions are reset to the default of none
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the any of the specified Permissions is {@code null}
     ...
     * <br><b>Note: Permissions not marked as {@link net.dv8tion.jda.core.Permission#isChannel() isChannel()} will have no affect!</b>
     *
     * @param permissions The Permissions representing the granted
     *                    permissions for the new PermissionOverride.
     *                    <br>If the provided value is {@code null} the permissions are reset to the default of none
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the any of the specified Permissions is {@code null}
     ...
     * <br><b>Note: Permissions not marked as {@link net.dv8tion.jda.core.Permission#isChannel() isChannel()} will have no affect!</b>
     *
     * @param denyBits The <b>positive</b> bits representing the denied
     *                 permissions for the new PermissionOverride
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the provided bits are negative
     *                                            or higher than {@link net.dv8tion.jda.core.Permission#ALL_PERMISSIONS Permission.ALL_PERMISSIONS}
     ...
     *
     * @param permissions The Collection of Permissions representing the denied
     *                    permissions for the new PermissionOverride.
     *                    <br>If the provided value is {@code null} the permissions are reset to the default of none
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the any of the specified Permissions is {@code null}
     ...
     * <br><b>Note: Permissions not marked as {@link net.dv8tion.jda.core.Permission#isChannel() isChannel()} will have no affect!</b>
     *
     * @param permissions The Permissions representing the denied
     *                    permissions for the new PermissionOverride.
     *                    <br>If the provided value is {@code null} the permissions are reset to the default of none
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If the any of the specified Permissions is {@code null}
     ...
     *
     * @param allowBits A non-negative bitwise representation
     *                  of granted Permissions
     * @param denyBits  A non-negative bitwise representation
     *                  of denied Permissions
     * @return The current PermissionOverrideAction - for chaining convenience
     * @throws java.lang.IllegalArgumentException If any of the provided bits are negative
     *                                            or higher than {@link net.dv8tion.jda.core.Permission#ALL_PERMISSIONS Permission.ALL_PERMISSIONS}
