...
public class RoleAction extends AuditableRestAction<Role> {
     ...
     *
     * @param route A {@link net.dv8tion.jda.core.requests.Route.CompiledRoute CompiledRoute}
     *              Which will be used for the Role creation.
     * @param guild The {@link net.dv8tion.jda.core.entities.Guild Guild} for which the Role should be created.
     */
     ...
     *
     * @param permissions The varargs {@link net.dv8tion.jda.core.Permission Permissions} for the new role
     * @return The current RoleAction, for chaining convenience
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged in account does not hold one of the specified permissions
     ...
     * the account is owner or {@link net.dv8tion.jda.core.Permission#ADMINISTRATOR admin} of the parent {@link net.dv8tion.jda.core.entities.Guild Guild}.
     *
     * @param permissions A {@link java.util.Collection Collection} of {@link net.dv8tion.jda.core.Permission Permissions} for the new role
     * @return The current RoleAction, for chaining convenience
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged in account does not hold one of the specified permissions
     * @throws IllegalArgumentException                                        If any of the provided permissions is {@code null}
     ...
     * the account is owner or {@link net.dv8tion.jda.core.Permission#ADMINISTRATOR admin} of the parent {@link net.dv8tion.jda.core.entities.Guild Guild}.
     *
     * @param permissions The raw {@link net.dv8tion.jda.core.Permission Permissions} value for the new role.
