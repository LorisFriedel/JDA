 ...
 *
 * @param <T> The type of {@link net.dv8tion.jda.core.entities.Channel Channel} to move
...
public class CategoryOrderAction<T extends Channel> extends ChannelOrderAction<T> {
     ...
     *
     * @param category The target {@link net.dv8tion.jda.core.entities.Category Category}
     *                 which the new CategoryOrderAction will order channels from.
     * @param type     The {@link net.dv8tion.jda.core.entities.ChannelType ChannelType} that
     ...
     * @throws java.lang.IllegalArgumentException If the {@code ChannelType} is not one that can be retrieved from a {@code Category}.
