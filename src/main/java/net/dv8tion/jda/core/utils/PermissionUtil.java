...
public class PermissionUtil {
     ...
     *
     * @param member      The {@link net.dv8tion.jda.core.entities.Member Member} whose permissions are being checked.
...
//            return true; // can be removed as getEffectivePermissions calculates these cases in
     ...
     *
     * @param channel The {@link net.dv8tion.jda.core.entities.Channel Channel} in which permissions are being checked.
     * @param role    The {@link net.dv8tion.jda.core.entities.Role Role} whose permissions are being checked.
     ...
     *
     * @param member The non-null {@link net.dv8tion.jda.core.entities.Member Member} for which to get implicit permissions
     ...
     *
     * @param channel The target channel of which to check {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverrides}
     * @param member  The non-null {@link net.dv8tion.jda.core.entities.Member Member} for which to get implicit permissions
     ...
     *
     * @param channel The target channel of which to check {@link net.dv8tion.jda.core.entities.PermissionOverride PermissionOverrides}
     * @param role    The non-null {@link net.dv8tion.jda.core.entities.Role Role} for which to get implicit permissions
