...
public class WidgetUtil {
     ...
     * @throws net.dv8tion.jda.core.exceptions.RateLimitedException If the request was rate limited, <b>respect the timeout</b>!
     * @throws java.lang.NumberFormatException                      If the provided {@code guildId} cannot be parsed by {@link Long#parseLong(String)}
     */
