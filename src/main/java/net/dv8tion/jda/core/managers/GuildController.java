...
public class GuildController {
     ...
     *
     * @param guild The {@link net.dv8tion.jda.core.entities.Guild Guild}
     ...
     * @param voiceChannel The destination {@link net.dv8tion.jda.core.entities.VoiceChannel VoiceChannel} to which the member is being
     *                     moved to.
     ...
     * </ul>
     *
     * @param member   The {@link net.dv8tion.jda.core.entities.Member Member} for which the nickname should be changed.
     * @param nickname The new nickname of the {@link net.dv8tion.jda.core.entities.Member Member}, provide {@code null} or an
     *                 empty String to reset the nickname
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws IllegalArgumentException                                        If the specified {@link net.dv8tion.jda.core.entities.Member Member}
     ...
     *                                                                         </ul>
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If attempting to set nickname for another member and the logged in account cannot manipulate the other user due to permission hierarchy position.
     ...
     * </ul>
     *
     * @param member The {@link net.dv8tion.jda.core.entities.Member Member} to kick
     ...
     * @throws java.lang.IllegalArgumentException                              If the provided member is not a Member of this Guild or is {@code null}
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#KICK_MEMBERS} permission.
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the logged in account cannot kick the other member due to permission hierarchy position.
     *                                                                         <br>See {@link net.dv8tion.jda.core.utils.PermissionUtil#canInteract(Member, Member) PermissionUtil.canInteract(Member, Member)}
     */
    @CheckReturnValue
     ...
     * </ul>
     *
     * @param userId The id of the {@link net.dv8tion.jda.core.entities.User User} to kick
     *               from the from the {@link net.dv8tion.jda.core.entities.Guild Guild}.
     * @param reason The reason for this action or {@code null} if there is no specified reason
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#KICK_MEMBERS} permission.
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the logged in account cannot kick the other member due to permission hierarchy position.
     *                                                                         <br>See {@link net.dv8tion.jda.core.utils.PermissionUtil#canInteract(Member, Member) PermissionUtil.canInteract(Member, Member)}
     * @throws java.lang.IllegalArgumentException                              If the userId provided does not correspond to a Member in this Guild or the provided {@code userId} is blank/null.
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     */
    @CheckReturnValue
     ...
     * </ul>
     *
     * @param member The {@link net.dv8tion.jda.core.entities.Member Member} to kick from the from the {@link net.dv8tion.jda.core.entities.Guild Guild}.
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * Kicks the provided Member from the current Guild
     * @throws java.lang.IllegalArgumentException                              If the provided member is not a Member of this Guild or is {@code null}
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     ...
     * </ul>
     *
     * @param userId The id of the {@link net.dv8tion.jda.core.entities.User User} to kick from the from the {@link net.dv8tion.jda.core.entities.Guild Guild}.
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#KICK_MEMBERS} permission.
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the logged in account cannot kick the other member due to permission hierarchy position.
     *                                                                         <br>See {@link net.dv8tion.jda.core.utils.PermissionUtil#canInteract(Member, Member) PermissionUtil.canInteract(Member, Member)}
     ...
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the logged in account cannot ban the other user due to permission hierarchy position.
     *                                                                         <br>See {@link net.dv8tion.jda.core.utils.PermissionUtil#canInteract(Member, Member) PermissionUtil.canInteract(Member, Member)}
     ...
     * </ul>
     *
     * @param member The {@link net.dv8tion.jda.core.entities.Member Member} who's {@link GuildVoiceState VoiceState} is being changed.
     * @param deafen Whether this {@link net.dv8tion.jda.core.entities.Member Member} should be deafened or undeafened.
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#VOICE_DEAF_OTHERS} permission.
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the provided member is the Guild's owner. You cannot modify the owner of a Guild.
     ...
     *
     * @param member The {@link net.dv8tion.jda.core.entities.Member Member} who's {@link GuildVoiceState VoiceState} is being changed.
     * @param mute   Whether this {@link net.dv8tion.jda.core.entities.Member Member} should be muted or unmuted.
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#VOICE_DEAF_OTHERS} permission.
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the provided member is the Guild's owner. You cannot modify the owner of a Guild.
     * @throws java.lang.IllegalArgumentException                              If the provided member is not from this Guild or null.
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     */
    @CheckReturnValue
     ...
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the provided roles are higher in the Guild's hierarchy
     ...
     * </ul>
     *
     * @param member Not-null {@link net.dv8tion.jda.core.entities.Member Member} that will receive all provided roles
     ...
     * </ul>
     *
     * @param member Not-null {@link net.dv8tion.jda.core.entities.Member Member} from which to remove the {@link net.dv8tion.jda.core.entities.Role Roles}
     ...
     * @param rolesToAdd    A {@link java.util.Collection Collection} of {@link net.dv8tion.jda.core.entities.Role Roles}
     *                      to add to the current Roles the specified {@link net.dv8tion.jda.core.entities.Member Member} already has
     * @param rolesToRemove A {@link java.util.Collection Collection} of {@link net.dv8tion.jda.core.entities.Role Roles}
     ...
     * </ul>
     *
     * @param member A {@link net.dv8tion.jda.core.entities.Member Member} of which to override the Roles of
     * @param roles  New collection of {@link net.dv8tion.jda.core.entities.Role Roles} for the specified Member
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged in account does not have {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES Permission.MANAGE_ROLES}
     * @throws net.dv8tion.jda.core.exceptions.HierarchyException              If the provided roles are higher in the Guild's hierarchy
     ...
     * @return {@link net.dv8tion.jda.core.requests.restaction.AuditableRestAction AuditableRestAction}
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     * @throws net.dv8tion.jda.core.exceptions.PermissionException       If the currently logged in account is not the owner of this Guild
     * @throws IllegalArgumentException                                  <ul>
     ...
     * </ul>
     *
     * @param channel The {@link net.dv8tion.jda.core.entities.Channel Channel} to use for the copy template
     * @return A specific {@link net.dv8tion.jda.core.requests.restaction.ChannelAction ChannelAction}
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the currently logged in account does not have the {@link net.dv8tion.jda.core.Permission#MANAGE_CHANNEL MANAGE_CHANNEL} Permission
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES} Permission
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     */
    @CheckReturnValue
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#MANAGE_ROLES} Permission and every Permission the provided Role has
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     ...
     * @param roles The {@link net.dv8tion.jda.core.entities.Role Roles} the new Emote should be restricted to
     ...
     * @throws net.dv8tion.jda.core.exceptions.InsufficientPermissionException If the logged in account does not have the {@link net.dv8tion.jda.core.Permission#MANAGE_EMOTES MANAGE_EMOTES} Permission
     * @throws net.dv8tion.jda.core.exceptions.GuildUnavailableException       If the guild is temporarily not {@link net.dv8tion.jda.core.entities.Guild#isAvailable() available}
     */
    @CheckReturnValue
     ...
     * </ul>
     *
     * @param category The {@link net.dv8tion.jda.core.entities.Category Category} to order
