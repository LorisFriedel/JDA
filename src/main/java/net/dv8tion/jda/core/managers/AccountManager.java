...
public class AccountManager extends ManagerBase {
     ...
     *
     * @param name            The new username
     * @param currentPassword The current password for the represented account,
     *                        this is only required for {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
     * @return AccountManager for chaining convenience
     * @throws IllegalArgumentException If this is action is performed on an account with the type {@link net.dv8tion.jda.core.AccountType#CLIENT CLIENT}
     ...
     *
     * @param avatar An {@link net.dv8tion.jda.core.entities.Icon Icon} instance representing
     ...
     *                        this is only required for {@link net.dv8tion.jda.core.AccountType#CLIENT AccountType.CLIENT}
     * @return AccountManager for chaining convenience
     * @throws IllegalArgumentException If the provided {@code currentPassword} is {@code null} or empty and the currently
     ...
     * @return AccountManager for chaining convenience
     * @throws net.dv8tion.jda.core.exceptions.AccountTypeException If the currently logged in account is not from {@link net.dv8tion.jda.core.AccountType#CLIENT}
