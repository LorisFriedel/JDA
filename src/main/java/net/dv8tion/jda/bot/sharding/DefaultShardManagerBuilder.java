...
public class DefaultShardManagerBuilder {
     ...
     *
     * @param provider The provider for <b>modifiable</b> context maps to use in JDA, or {@code null} to reset
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     ...
     * given listener(s) <b>must</b> be instance of {@link net.dv8tion.jda.core.hooks.EventListener EventListener}!
     *
     * @param listenerProvider The listener provider to add to the list of listener providers.
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     */
     ...
     * given listener(s) <b>must</b> be instance of {@link net.dv8tion.jda.core.hooks.EventListener EventListener}!
     *
     * @param listenerProviders The listener provider to add to the list of listener providers.
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     */
     ...
     *
     * @param listenerProvider The listener provider to remove from the list of listener providers.
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     */
     ...
     *
     * @param listenerProviders The listener provider(s) to remove from the list of listener providers.
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     */
     ...
     * <p>Default: <b>true (enabled)</b>
     *
     * @param enable True (default) - use shutdown hook to clean up the ShardManager and it's JDA instances if the Java program is closed.
     ...
     * {@link net.dv8tion.jda.core.entities.Game#streaming(String, String) Game.streaming(String, String)}.
     *
     * @param gameProvider An instance of {@link net.dv8tion.jda.core.entities.Game Game} (null allowed)
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     * @see net.dv8tion.jda.core.managers.Presence#setGame(Game)
     */
     ...
     *
     * @param idle boolean value that will be provided with our IDENTIFY packages to mark our sessions as afk or not. <b>(default false)</b>
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     ...
     * {@link DefaultShardManager#setIdle(boolean) DefaultShardManager#setIdleProvider(boolean)}.
     *
     * @param idleProvider boolean value that will be provided with our IDENTIFY packages to mark our sessions as afk or not. <b>(default false)</b>
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     * @see net.dv8tion.jda.core.managers.Presence#setIdle(boolean)
     */
     ...
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
     * @throws IllegalArgumentException If either minShardId is negative, maxShardId is lower than shardsTotal or
     ...
     *
     * @param shardsTotal The number of overall shards or {@code -1} if JDA should use the recommended amount from discord.
     * @return The {@link net.dv8tion.jda.bot.sharding.DefaultShardManagerBuilder DefaultShardManagerBuilder} instance. Useful for chaining.
