...
public interface ApplicationInfo extends ISnowflake {
     ...
     *
     * @param permissions Possibly empty {@link java.util.Collection Collection} of {@link net.dv8tion.jda.core.Permission Permissions}
     ...
     * <br>Unnecessary query parameters are stripped.
     *
     * @param permissions {@link net.dv8tion.jda.core.Permission Permissions} that should be requested via invite.
     * @return The link used to invite the bot
     */
